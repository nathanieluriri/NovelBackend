...
from schemas.comments_schema import CommentCreate, CommentOut,CommentBaseRequest
from typing import List
from services.comments_services import add_Comment,remove_Comment,retrieve_user_Comments,retrieve_chapter_Comments
...
async def get_all_available_Comments(dep= Depends(verify_any_token)):
    try:
        if dep['role']=='admin':
...
@router.delete("/remove/{CommentId}", response_model=CommentOut)
async def unComment(CommentId: str):
    try:
