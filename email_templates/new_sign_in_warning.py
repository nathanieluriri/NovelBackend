...
def generate_new_signin_warning_email_from_template(firstName,lastName,time_data,ip_address,location,extra_data):
    generated_email = new_signin_warning_template_string.safe_substitute(firstName=firstName,lastName=lastName,time_data=time_data,ip_address=ip_address,location=location,extra_data=extra_data )
