from repositories.admin_repo import get_admin_by_email, create_admin,delete_admin_by_email_and_provider, get_allowd_admin_emails
...
async def register_admin_func(user_data: NewAdminCreate):
    if get_allowd_admin_emails(user_data.email)!=None:
